...
public class QuestionController {
	...
	public ResponseEntity<List<QuestionDTO>> addMultipleQuestions(@RequestBody List<QuestionDTO> dtos) {
		...
		//List<QuestionDTO> updatedDTO=questions.stream().map(QuestionMapper::toDTO).toList();
...
//@PreAuthorize("hasRole('ADMIN')")
	...
	/***
	 * For Retrieving ExamId and QuestionId mapping in ExamQuestionMapping
	 * @param examId
	 * @param id
	 * @return QuestionDTO
	 */
